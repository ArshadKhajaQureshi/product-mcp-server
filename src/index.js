...
//Tool 2: create_product — create a new product in the catalogue
...
// Tool 3: run_tests — execute the test suite and return the result
...
//Resource 1: product://catalogue — live snapshot of all active products
...
// Resource 2: product://openapi — the OpenAPI 3.1 specification
...
//Prompt 2: seed_test_data — instructions for seeding realistic test products
server.registerPrompt(
  'seed_test_data',
  {
    name:        'Seed Test Data',
